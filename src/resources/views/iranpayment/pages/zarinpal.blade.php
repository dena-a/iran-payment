...
@section('title', 'انتقال به درگاه زرین‌پال')
...
<div class="container">
	<div class="content">
		...
		<h2>درحال انتقال به درگاه زرین‌پال...</h2>
		<div class="l-box-lrg is-center pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">
			<img class="pure-img-responsive" src="https://raw.githubusercontent.com/dena-a/iran-payment/master/src/resources/assets/img/zp.png">
		</div>
